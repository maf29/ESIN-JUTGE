...
using namespace std;
Abin<int> crear_arbre(){	//se cre apor preordre
	Abin<int> T;
	int n;
	cin >> n;
...
void postordre (Abin<int>::iterador it1, Abin<int>::iterador it2){
	// izquierdo - derecho - arrel
	if(it1 != it2){ //mientras no llegara l final del arbol
		postordre(it1.fesq(), it2);
		postordre(it1.fdret(), it2);
		cout << " " << *it1;
	}
}
void inordre (Abin<int>::iterador it1, Abin<int>::iterador it2){
	//esq - arrel dret
	if(it1 != it2){ //mientras no llegara l final del arbol
